 ...
 */
final class Version20251215153317 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('ALTER TABLE discussion_post_likes ADD CONSTRAINT FK_5C5A508EA76ED395 FOREIGN KEY (user_id) REFERENCES users (id) ON DELETE CASCADE NOT DEFERRABLE');
    ...
    public function down(Schema $schema): void
    {
        ...
        $this->addSql('ALTER TABLE discussion_post_likes ADD CONSTRAINT fk_5c5a508eb4622ec2 FOREIGN KEY (liked_by_id) REFERENCES users (id) ON DELETE CASCADE NOT DEFERRABLE INITIALLY IMMEDIATE');
